...
func (in *CanUpdateMachineResponse) DeepCopyInto(out *CanUpdateMachineResponse) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.CommonResponse = in.CommonResponse
	if in.MachinePatch != nil {
		in, out := &in.MachinePatch, &out.MachinePatch
		*out = new(Patch)
		(*in).DeepCopyInto(*out)
	}
	if in.InfrastructureMachinePatch != nil {
		in, out := &in.InfrastructureMachinePatch, &out.InfrastructureMachinePatch
		*out = new(Patch)
		(*in).DeepCopyInto(*out)
	}
	if in.BootstrapConfigPatch != nil {
		in, out := &in.BootstrapConfigPatch, &out.BootstrapConfigPatch
		*out = new(Patch)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *CanUpdateMachineSetResponse) DeepCopyInto(out *CanUpdateMachineSetResponse) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.CommonResponse = in.CommonResponse
	if in.MachineSetPatch != nil {
		in, out := &in.MachineSetPatch, &out.MachineSetPatch
		*out = new(Patch)
		(*in).DeepCopyInto(*out)
	}
	if in.InfrastructureMachineTemplateSpecPatch != nil {
		in, out := &in.InfrastructureMachineTemplateSpecPatch, &out.InfrastructureMachineTemplateSpecPatch
		*out = new(Patch)
		(*in).DeepCopyInto(*out)
	}
	if in.BootstrapConfigTemplateSpecPatch != nil {
		in, out := &in.BootstrapConfigTemplateSpecPatch, &out.BootstrapConfigTemplateSpecPatch
		*out = new(Patch)
		(*in).DeepCopyInto(*out)
	}
}
